...
CREATE TABLE IF NOT EXISTS `dc_ess_data`.`formdata` (
  ...
  `ACCT` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
  `By` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
  `By_2` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `LICENSEE_ACCOUNT_NAME` VARCHAR(400) NULL DEFAULT NULL COMMENT '',
  `ADDRESS` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `ATTENTION_OR_CO` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `CITY` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `STATE` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `ZIP` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `company` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `CORPORATE_OR_PERSONAL_ACCOUNT_1` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `DAY_PHONE` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `EMAIL_ADDRESS` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `first` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `last` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `NumofSeats` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `PARKING_SPACES` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Row` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Seats` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Section` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `LOCATION_OF_SEATS_Section` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `title` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Total` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `TotalFees` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Date_2` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y1` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y2` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y3` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y4` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y5` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y6` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y7` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y8` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y9` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y10` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y11` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y12` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y13` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y14` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Y15` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `_es_` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Title_2` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `NIGHT_PHONE` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Table` VARCHAR(50) NULL DEFAULT NULL COMMENT '',
  `LOCATION_OF_TABLESEATS_Section` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `FAX` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `of_Seats` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `LICENSEE` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `efield26_NumofSeats` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Custom_Field_1` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year1` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year1Fee` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year2` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year2Fee` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year3` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year3Fee` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year4` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year4Fee` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year5` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `Year5Fee` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `#ofSeats` VARCHAR(50) NULL DEFAULT NULL COMMENT '')
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
